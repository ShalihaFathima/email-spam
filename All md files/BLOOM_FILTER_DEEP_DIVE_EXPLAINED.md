...
```
┌─────────────────────────────────────────────────────────────┐
│ Bloom Filter Bit Array (1024 bits / 128 bytes)              │
├─────────────────────────────────────────────────────────────┤
│                                                               │
│  Byte 0:   [0][0][0][1][0][1][1][0]  (bits 0-7)            │
│  Byte 1:   [1][0][1][0][1][0][1][0]  (bits 8-15)           │
│  Byte 2:   [0][1][0][1][0][1][0][1]  (bits 16-23)          │
│  Byte 3:   [1][1][1][0][0][1][0][1]  (bits 24-31)          │
│  ...                                                        │
│  Byte 127: [1][1][0][1][1][0][1][0] (bits 1016-1023)      │
│                                                               │
│  Each [0] or [1] represents one bit                         │
│  When keyword inserted: 4 bits are SET to 1                 │
│  (one for each hash function result)                        │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
